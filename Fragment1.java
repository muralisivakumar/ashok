...
public class Fragment1 extends Fragment 
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) 
	{
		...
		//BenefitsData();
        View rootView = inflater.inflate(R.layout.activity_view_page1, container, false);
...
salaryListAdapter = new SalaryListAdapter(getActivity(), l1);
				 ...
				 list.setOnItemClickListener(new OnItemClickListener() 
					{
						...
						public void onItemClick(AdapterView<?> arg0, View arg1, int pos,long arg3) 
						{
							...
							Toast.makeText(getActivity(), "u have selected the row is"+pos, Toast.LENGTH_SHORT).show();
					...
					search.setOnClickListener(new OnClickListener() 
					{
						...
						public void onClick(View arg0) 
						{
					        ...
					        final EditText uname = new EditText(getActivity());
					      ...
					      month.setHint(MONTH);
					        ...
					        final EditText from = new EditText(getActivity());
					        from.setHint(FROM);
					        final EditText to= new EditText(getActivity());
					         to.setHint(TO);
					         layout.addView(from);
						        layout.addView(to);
						        alert.setView(layout);
